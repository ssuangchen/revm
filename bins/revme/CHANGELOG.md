...
## [0.5.0](https://github.com/ssuangchen/revm/compare/revme-v0.4.0...revme-v0.5.0) - 2024-05-03

### Added
- *(revme)* add --keep-going to statetest command ([#1277](https://github.com/ssuangchen/revm/pull/1277))
- EOF (Ethereum Object Format) ([#1143](https://github.com/ssuangchen/revm/pull/1143))

### Fixed
- *(revme)* Print one json outcome in statetest ([#1347](https://github.com/ssuangchen/revm/pull/1347))
- Drops check for .json when testing a single file ([#1301](https://github.com/ssuangchen/revm/pull/1301))
