...
## [5.1.0](https://github.com/ssuangchen/revm/compare/revm-database-v5.0.0...revm-database-v5.1.0) - 2025-06-15
...
- change account state to None if NotExisting on insert_account_info ([#2630](https://github.com/ssuangchen/revm/pull/2630))
