...
## [9.0.0](https://github.com/ssuangchen/revm/compare/revm-v8.0.0...revm-v9.0.0) - 2024-05-03

### Added
- *(Handler)* Add ClearHandle ([#1368](https://github.com/ssuangchen/revm/pull/1368))
- Add uniswap V2 WETH-USDC swap example ([#1353](https://github.com/ssuangchen/revm/pull/1353))
...
- *(ci)* bump action/deploy ([#1372](https://github.com/ssuangchen/revm/pull/1372))
