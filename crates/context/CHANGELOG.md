...
## [7.0.0](https://github.com/ssuangchen/revm/compare/revm-context-v6.0.0...revm-context-v7.0.0) - 2025-06-15

### Added

- *(precompile)* rug/gmp-based modexp ([#2596](https://github.com/ssuangchen/revm/pull/2596))
- change blob_max_count to max_blobs_per_tx ([#2608](https://github.com/ssuangchen/revm/pull/2608))
- add optional priority fee check configuration ([#2588](https://github.com/ssuangchen/revm/pull/2588))

### Other

- optimize warm_preloaded_addresses reset ([#2625](https://github.com/ssuangchen/revm/pull/2625))
- rename `transact` methods ([#2616](https://github.com/ssuangchen/revm/pull/2616))
