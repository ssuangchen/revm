...
## [21.1.0](https://github.com/ssuangchen/revm/compare/revm-interpreter-v21.0.0...revm-interpreter-v21.1.0) - 2025-06-15

### Added

- *(precompile)* rug/gmp-based modexp ([#2596](https://github.com/ssuangchen/revm/pull/2596))
- add clz opcode ([#2598](https://github.com/ssuangchen/revm/pull/2598))
- added instruction_result fn in LoopControl trait  ([#2595](https://github.com/ssuangchen/revm/pull/2595))

### Other

- make CallInput default 0..0 ([#2621](https://github.com/ssuangchen/revm/pull/2621))
