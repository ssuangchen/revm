...
## [2.0.0](https://github.com/ssuangchen/revm/compare/revm-interpreter-v1.3.0...revm-interpreter-v2.0.0) - 2024-02-06

### Added
- tweeks for v4.0 revm release ([#1048](https://github.com/ssuangchen/revm/pull/1048))
- add `BytecodeLocked::original_bytecode` ([#1037](https://github.com/ssuangchen/revm/pull/1037))
...
- add some conversions to InstructionResult ([#910](https://github.com/ssuangchen/revm/pull/910))
- implement Default for InstructionResult ([#878](https://github.com/ssuangchen/revm/pull/878))
...
### Fixed
- *(Interpreter)* is_revert should call is_revert ([#1007](https://github.com/ssuangchen/revm/pull/1007))
- cast overflow in 32-bits OS ([#978](https://github.com/ssuangchen/revm/pull/978))
...
- *(interpreter)* Stack `push_slice` fix and dup with pointers ([#837](https://github.com/ssuangchen/revm/pull/837))
...
- expose InstructionResult getters in Interpreter result ([#1002](https://github.com/ssuangchen/revm/pull/1002))
...
- *(interpreter)* consistency in all_results_are_covered() ([#961](https://github.com/ssuangchen/revm/pull/961))
- *(interpreter)* local return_error! macro ([#956](https://github.com/ssuangchen/revm/pull/956))
- *(interpreter)* simplify the logic of calc.new_cost() ([#939](https://github.com/ssuangchen/revm/pull/939))
- *(interpreter)* fix the name of the macro referenced by record_memory() ([#926](https://github.com/ssuangchen/revm/pull/926))
- *(interpreter)* conditionally enable `optional_beneficiary_reward` ([#925](https://github.com/ssuangchen/revm/pull/925))
- fix case for CreateInitCodeSizeLimit error ([#896](https://github.com/ssuangchen/revm/pull/896))
- simplify use statements ([#864](https://github.com/ssuangchen/revm/pull/864))
- *(interpreter)* use the constants from primitives ([#861](https://github.com/ssuangchen/revm/pull/861))
- review safety comments ([#811](https://github.com/ssuangchen/revm/pull/811))
- rewrite `Stack::push_slice` to allow arbitrary lengths ([#812](https://github.com/ssuangchen/revm/pull/812))
- make context memory pub ([#831](https://github.com/ssuangchen/revm/pull/831))
...
- make memory-limit private ([#796](https://github.com/ssuangchen/revm/pull/796))
