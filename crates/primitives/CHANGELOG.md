...
## [4.0.0](https://github.com/ssuangchen/revm/compare/revm-primitives-v3.1.1...revm-primitives-v4.0.0) - 2024-05-03

### Added
- implement EIP-2935 ([#1354](https://github.com/ssuangchen/revm/pull/1354))
- add `Bytecode::original_bytecode_slice` to match `BytecodeLocked` ([#1286](https://github.com/ssuangchen/revm/pull/1286))
...
- pass rand feature to alloy_primitives ([#1276](https://github.com/ssuangchen/revm/pull/1276))
