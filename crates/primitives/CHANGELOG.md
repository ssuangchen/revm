...
## [2.0.0](https://github.com/ssuangchen/revm/compare/revm-primitives-v1.3.0...revm-primitives-v2.0.0) - 2024-02-06
...
- add is_empty_code_hash fn ([#826](https://github.com/ssuangchen/revm/pull/826))
...
- add changed storage slots iter ([#801](https://github.com/ssuangchen/revm/pull/801))
- derive more traits ([#745](https://github.com/ssuangchen/revm/pull/745))

### Fixed
- use maximum possible data fee for 4844 balance checks ([#981](https://github.com/ssuangchen/revm/pull/981))
- make revm-primitives no-std with c-kzg feature ([#933](https://github.com/ssuangchen/revm/pull/933))
...
- *(primitives)* Error Primitive Display + Error Implementations ([#770](https://github.com/ssuangchen/revm/pull/770))
...
- add some docs to StorageSlot ([#1019](https://github.com/ssuangchen/revm/pull/1019))
- fix serde std flags for no-std build ([#987](https://github.com/ssuangchen/revm/pull/987))
- *(deps)* bump bitflags from 2.4.1 to 2.4.2 ([#983](https://github.com/ssuangchen/revm/pull/983))
...
- *(deps)* alloy 0.6 ([#963](https://github.com/ssuangchen/revm/pull/963))
- *(primitives)* improve readability of Env.validate_tx() ([#924](https://github.com/ssuangchen/revm/pull/924))
- *(primitives)* optimize AccountInfo.is_empty() ([#922](https://github.com/ssuangchen/revm/pull/922))
...
- *(deps)* run `cargo update`, bump alloy-primitives ([#880](https://github.com/ssuangchen/revm/pull/880))
- *(primitives)* don't duplicate the SpecId::enabled() logic ([#869](https://github.com/ssuangchen/revm/pull/869))
...
- *(deps)* make derive-more optional ([#827](https://github.com/ssuangchen/revm/pull/827))
- *(eip4844)* update kzg trusted setup ([#822](https://github.com/ssuangchen/revm/pull/822))
- *(deps)* bump bitflags from 2.4.0 to 2.4.1 ([#803](https://github.com/ssuangchen/revm/pull/803))
- include alloy-primitives std feature ([#788](https://github.com/ssuangchen/revm/pull/788))
- *(primitives)* OptimismFields Docs Cleanup ([#778](https://github.com/ssuangchen/revm/pull/778))
...
- *(primitives)* Clean up the account typs with docs ([#776](https://github.com/ssuangchen/revm/pull/776))
...
- reorder env members ([#771](https://github.com/ssuangchen/revm/pull/771))
