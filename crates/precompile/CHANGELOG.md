...
## [23.0.0](https://github.com/ssuangchen/revm/compare/revm-precompile-v22.0.0...revm-precompile-v23.0.0) - 2025-06-15

### Added

- *(precompile)* rug/gmp-based modexp ([#2596](https://github.com/ssuangchen/revm/pull/2596))
- add basic tests for modexp ([#2603](https://github.com/ssuangchen/revm/pull/2603))
- enable P256 in Osaka ([#2601](https://github.com/ssuangchen/revm/pull/2601))

### Other

- build less benchmark binaries ([#2629](https://github.com/ssuangchen/revm/pull/2629))
