...
## [7.0.0](https://github.com/ssuangchen/revm/compare/revm-inspector-v6.0.0...revm-inspector-v7.0.0) - 2025-06-15

### Added

- *(precompile)* rug/gmp-based modexp ([#2596](https://github.com/ssuangchen/revm/pull/2596))
- add Inspector implementation for either::Either ([#2614](https://github.com/ssuangchen/revm/pull/2614))
- *(InspectEvm)* add inspect_finalize method for tx+inspector with state ([#2593](https://github.com/ssuangchen/revm/pull/2593))
