...
## [5.0.0](https://github.com/ssuangchen/revm/compare/revm-bytecode-v4.1.0...revm-bytecode-v5.0.0) - 2025-06-15
...
- *(tests)* extend test for is_valid jumptable ([#2622](https://github.com/ssuangchen/revm/pull/2622))
- faster JumpTable bits lookup ([#2618](https://github.com/ssuangchen/revm/pull/2618))
